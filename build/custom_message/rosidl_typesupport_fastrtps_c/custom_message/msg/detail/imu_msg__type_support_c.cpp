...
#include "custom_message/msg/detail/imu_msg__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/string__functions.h"  // first_string, second_string
...
using _ImuMsg__ros_msg_type = custom_message__msg__ImuMsg;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: first_string
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->first_string, cdr))
    {
      return false;
    }
  }

  // Field name: second_string
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
...
static uint32_t _ImuMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_message__msg__ImuMsg(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_message__msg__ImuMsg;
    is_plain =
      (
...
static size_t _ImuMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_message__msg__ImuMsg(
