...
{
  new (message_memory) custom_message::msg::ImuMsg(_init);
}

void ImuMsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_message::msg::ImuMsg *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ImuMsg_message_member_array[3] = {
  {
    ...
    offsetof(custom_message::msg::ImuMsg, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_message::msg::ImuMsg, first_string),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_message::msg::ImuMsg, second_string),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ImuMsg_message_members = {
  ...
  "ImuMsg",  // message name
  3,  // number of fields
  sizeof(custom_message::msg::ImuMsg),
...
{
  return &::custom_message::msg::rosidl_typesupport_introspection_cpp::ImuMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_message, msg, ImuMsg)() {
  return &::custom_message::msg::rosidl_typesupport_introspection_cpp::ImuMsg_message_type_support_handle;
}
