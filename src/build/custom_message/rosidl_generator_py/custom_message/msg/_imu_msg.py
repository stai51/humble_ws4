...
class ImuMsg(metaclass=Metaclass_ImuMsg):
    ...
    _fields_and_field_types = {
        ...
        'first_string': 'std_msgs/String',
        'second_string': 'std_msgs/String',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from std_msgs.msg import String
        self.first_string = kwargs.get('first_string', String())
        from std_msgs.msg import String
        self.second_string = kwargs.get('second_string', String())
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.first_string != other.first_string:
            return False
        if self.second_string != other.second_string:
            return False
        return True
    ...
    def first_string(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'first_string' field must be a sub message of type 'String'"
        self._first_string = value

    @builtins.property
    def second_string(self):
        """Message field 'second_string'."""
        return self._second_string

    @second_string.setter
    def second_string(self, value):
        if __debug__:
            from std_msgs.msg import String
            assert \
                isinstance(value, String), \
                "The 'second_string' field must be a sub message of type 'String'"
        self._second_string = value
