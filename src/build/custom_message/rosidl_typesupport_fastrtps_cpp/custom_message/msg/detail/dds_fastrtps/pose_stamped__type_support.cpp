...
#include "custom_message/msg/detail/pose_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_message::msg::PoseStamped & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_message::msg::PoseStamped & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_message::msg::PoseStamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_message::msg::PoseStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_message::msg::PoseStamped *>(
    untyped_ros_message);
...
{
  return &custom_message::msg::typesupport_fastrtps_cpp::_PoseStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_message, msg, PoseStamped)() {
  return &custom_message::msg::typesupport_fastrtps_cpp::_PoseStamped__handle;
}
